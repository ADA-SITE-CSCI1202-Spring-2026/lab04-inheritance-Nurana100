...
public class InheritanceDemo {
    public static void main(String[] args) {
        ...
        Teacher t1 = new Teacher("John", "Doe", "Male", "Computer Science",
                        new String[]{"OOP", "Data Structures"});
        Teacher t2 = new Teacher("John", "Doe", "Male", "Computer Science",
                        new String[]{"OOP", "Data Structures"});
        Teacher t3 = new Teacher("Jane", "Doe", "Female", "Mathematics",
                        new String[]{"Calculus", "Algebra"});
